...
table_config = JSON.parse(File.read("#{File.dirname(__FILE__)}/../config/awesomebigdata.json"))
...
# write result
File.open("#{File.dirname(__FILE__)}/../public/awesomebigdata.md", 'w') { |file| file.write(ERB.new(File.read("#{File.dirname(__FILE__)}/templates/awesomebigdata.md"), nil, '-').result(binding)) } 
